...
- 🧭 **Modern config screen** — powered by Resourceful Config (bundled in, nothing to install); `/gz` opens it directly with clean categories (General / Colors / Version tags) and a color picker
